...
use anyhow::Result;
use clap::{Arg, Command, ArgAction}; // Add ArgMatches and ArgAction import
use log::info;
...
fn build_cli() -> Command {
    Command::new("ipc_dev_rust")
                ...
                .subcommand(
                    Command::new("add")
                        ...
                        .arg(Arg::new("thresholds")
                            ...
                            .help("Comma-separated RPM thresholds for each channel (e.g., 500,400,600)")
                            .value_delimiter(','))
                    ...
                    Command::new("rpm")
                        ...
                        .subcommand(
                            Command::new("register")
                                .about("Register new RPM device with multiple channels")
                                .arg(Arg::new("address")
                                    .long("address")
                                    .short('a')
                                    .value_name("ADDRESS")
                                ...
                                .arg(Arg::new("channels")
                                    ...
                                    .short('c')
                                    .value_name("COUNT")
                                    .help("Number of RPM channels (1-8)")
                                    .required(true))
                                .arg(Arg::new("thresholds")
                                    .long("thresholds")
                                    .value_name("THRESHOLDS")
                                ...
                                .arg(Arg::new("engine-types")
                                    .long("engine-types")
                                    .value_name("TYPES")
                                    .help("Comma-separated engine types for each channel (e.g., main,aux,gen)")
                                    .value_delimiter(','))
                                .arg(Arg::new("auto-detect")
                                    .long("auto-detect")
                                    .help("Enable auto-detection of channels")
                                    .action(clap::ArgAction::SetTrue))
                        )
                        .subcommand(
                            Command::new("update")
                                .about("Update RPM device configuration")
                                .arg(Arg::new("address")
                                    .long("address")
                                    .short('a')
                                    .value_name("ADDRESS")
                                    .help("Device Modbus address")
                                    .required(true))
                                .arg(Arg::new("channel")
                                    .long("channel")
                                    .value_name("CHANNEL")
                                    .help("Channel number to update (1-8)"))
                                .arg(Arg::new("threshold")
                                    .long("threshold")
                                    .value_name("RPM")
                                    .help("New RPM threshold for the channel"))
                                .arg(Arg::new("engine-type")
                                    .long("engine-type")
                                    .value_name("TYPE")
                                    .help("Engine type (main, aux, gen, etc.)"))
                        )
                ))
        .subcommand(
        ...
        .subcommand(
            Command::new("mtws")
                .about("MTWS (Maritime Tracking Web Service) commands")
                .subcommand(
                    Command::new("start")
                ...
                .subcommand(
                    Command::new("send")
                        .about("Send single MTWS payload")
                ...
                .subcommand(
                    Command::new("status")
                        .about("Show MTWS service status")
                )
                .subcommand(
                    Command::new("config")
                        .about("MTWS configuration commands")
                        .subcommand(
                            Command::new("show")
                                .about("Show current MTWS configuration")
                        )
                        .subcommand(
                            Command::new("set")
                                .about("Update MTWS configuration")
